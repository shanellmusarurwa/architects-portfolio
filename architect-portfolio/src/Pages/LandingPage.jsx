  ...
  return (
    ...
    <div className="images-column">
      <div className="small-image top">
        <img src="./src/assets/Rectangle 9.png" alt="Architecture detail 1" />
      </div>
      <div className="small-image bottom">
        <img src="./src/assets/Rectangle 10.png" alt="Architecture detail 2" />
      </div>
      <div className="large-image">
        <img src="./src/assets/Rectangle 8.png" alt="Architecture overview" />
      </div>
    </div>
      ...
      <section className="projects-section">
        ...
        <div className="projects-grid">
          ...
          <div className="project-card top-row">
            <img src="./src/assets/Rectangle 17.png" alt="Project 1" />
          </div>
          
          <div className="project-card top-row">
            <img src="./src/assets/image 15.png" alt="Project 2" />
          </div>
          
          {/* Bottom row - 3 projects */}
          <div className="project-card">
            <img src="./src/assets/image 16.png" alt="Project 3" />
          </div>
          
          <div className="project-card">
            <img src="./src/assets/image 17.png" alt="Project 4" />
          </div>
          
          <div className="project-card">
            <img src="./src/assets/image 18.png" alt="Project 5" />
          </div>
        </div>
